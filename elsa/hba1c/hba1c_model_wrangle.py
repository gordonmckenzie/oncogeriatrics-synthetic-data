...
nurse_final = nurse_filtered[["idauniq", "sex", "confage", "mean_pulse", "mean_sys", "hba1c", "mean_dias", "has_dyslipidaemia"]]
...
derived_final = derived_filtered[["idauniq", "has_hypertension", "has_diabetes", "has_arthritis", "has_asthma", "has_stroke", "has_mi", "has_dementia", "has_arrhythmia"]]
...
print(df_final["hba1c"].describe())

df_final.to_csv('elsa/hba1c/hba1c_model_wrangle.csv', index=False)