...
nurse_final = nurse_filtered[["idauniq", "sex", "confage", "mean_pulse", "mean_sys", "mean_dias", "has_dyslipidaemia"]]
...
df_final.to_csv('elsa/pulse/pulse_model_wrangle.csv', index=False)