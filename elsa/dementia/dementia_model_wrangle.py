...
nurse_final = nurse_filtered[["idauniq", "sex", "confage"]]
...
derived_final = derived_filtered[["idauniq", "has_hypertension", "has_diabetes", "has_arthritis", "has_asthma", "has_stroke", "has_mi", "has_dementia"]]
...
print(df_final[df_final["has_dementia"] == 1].describe())

#df_final.to_csv('elsa/dementia/dementia_model_wrangle.csv', index=False)